...
import '../features/authentication/services/user_service/supabase_user_service.dart'
    as _i23;
import '../features/feedback/services/appwrite_feedback_service.dart' as _i19;
import '../features/feedback/services/fast_feedback_service.dart' as _i17;
import '../features/feedback/services/firebase_feedback_service.dart' as _i18;
import '../features/feedback/services/supabase_feedback_service.dart' as _i20;
import '../features/monitoring/services/amplitude_analytics_service.dart'
    as _i4;
import '../features/monitoring/services/crash_service.dart' as _i16;
import '../features/monitoring/services/fast_analytics_service.dart' as _i3;
import '../features/monitoring/services/fast_crash_service.dart' as _i15;
import '../features/settings/services/settings_service.dart' as _i27;
...
import '../features/shared/services/connector_service/supabase_connector_service.dart'
    as _i12;
import '../features/shared/services/modules.dart' as _i28;
import '../features/subscriptions/services/subscription_service.dart' as _i26;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.factory<_i11.FastConnectorService>(
    () => _i14.AppwriteConnectorService(),
    registerFor: {_appwrite},
  );
  gh.singleton<_i15.FastCrashService>(_i16.CrashService());
  gh.lazySingleton<_i17.FastFeedbackService>(
    () => _i18.FirebaseFeedbackService(),
    registerFor: {_firebase},
  );
  gh.lazySingleton<_i17.FastFeedbackService>(
    () => _i19.AppwriteFeedbackService(),
    registerFor: {_appwrite},
  );
  gh.lazySingleton<_i17.FastFeedbackService>(
    () => _i20.SupabaseFeedbackService(),
    registerFor: {_supabase},
  );
  gh.lazySingleton<_i21.FastUserService>(
    () => _i22.AppwriteUserservice(),
    registerFor: {_appwrite},
  );
  gh.lazySingleton<_i21.FastUserService>(
    () => _i23.SupabaseUserService(),
    registerFor: {_supabase},
  );
  gh.lazySingleton<_i21.FastUserService>(
    () => _i24.FirebaseUserService(),
    registerFor: {_firebase},
  );
  ...
  gh.singleton<_i26.SubscriptionService>(_i26.SubscriptionService());
  gh.singleton<_i27.SettingsService>(_i27.SettingsService());
  return getIt;
}
