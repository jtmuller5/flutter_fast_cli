...
import '../features/authentication/services/user_service/supabase_user_service.dart'
    as _i26;
import '../features/feedback/services/appwrite_feedback_service.dart' as _i22;
import '../features/feedback/services/fast_feedback_service.dart' as _i19;
import '../features/feedback/services/firebase_feedback_service.dart' as _i20;
import '../features/feedback/services/pocketbase_feedback_service.dart' as _i21;
import '../features/feedback/services/supabase_feedback_service.dart' as _i23;
import '../features/monitoring/services/amplitude_analytics_service.dart'
    as _i5;
import '../features/monitoring/services/crash_service.dart' as _i18;
import '../features/monitoring/services/fast_analytics_service.dart' as _i4;
import '../features/monitoring/services/fast_crash_service.dart' as _i17;
import '../features/settings/services/settings_service.dart' as _i31;
...
import '../features/shared/services/modules.dart' as _i32;
import '../features/subscriptions/services/subscription_service.dart' as _i30;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.singleton<_i17.FastCrashService>(_i18.CrashService());
  gh.lazySingleton<_i19.FastFeedbackService>(
    () => _i20.FirebaseFeedbackService(),
    registerFor: {_firebase},
  );
  gh.lazySingleton<_i19.FastFeedbackService>(
    () => _i21.PocketBaseFeedbackService(),
    registerFor: {_pocketbase},
  );
  gh.lazySingleton<_i19.FastFeedbackService>(
    () => _i22.AppwriteFeedbackService(),
    registerFor: {_appwrite},
  );
  gh.lazySingleton<_i19.FastFeedbackService>(
    () => _i23.SupabaseFeedbackService(),
    registerFor: {_supabase},
  );
  gh.lazySingleton<_i24.FastUserService>(
    () => _i25.AppwriteUserservice(),
    registerFor: {_appwrite},
  );
  gh.lazySingleton<_i24.FastUserService>(
    () => _i26.SupabaseUserService(),
    registerFor: {_supabase},
  );
  gh.singleton<_i24.FastUserService>(
    _i27.PocketBaseUserService(),
    registerFor: {_pocketbase},
  );
  gh.lazySingleton<_i24.FastUserService>(
    () => _i28.FirebaseUserService(),
    registerFor: {_firebase},
  );
  ...
  gh.singleton<_i30.SubscriptionService>(_i30.SubscriptionService());
  gh.singleton<_i31.SettingsService>(_i31.SettingsService());
  return getIt;
}
