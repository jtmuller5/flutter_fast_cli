...
import '../features/authentication/services/user_service/supabase_user_service.dart'
    as _i22;
import '../features/feedback/services/appwrite_feedback_service.dart' as _i18;
...
import '../features/feedback/services/supabase_feedback_service.dart' as _i19;
...
import '../features/settings/services/settings_service.dart' as _i26;
...
import '../features/shared/services/connector_service/supabase_connector_service.dart'
    as _i12;
import '../features/shared/services/modules.dart' as _i27;
import '../features/subscriptions/services/subscription_service.dart' as _i25;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.lazySingleton<_i16.FastFeedbackService>(
    () => _i18.AppwriteFeedbackService(),
    registerFor: {_appwrite},
  );
  gh.lazySingleton<_i16.FastFeedbackService>(
    () => _i19.SupabaseFeedbackService(),
    registerFor: {_supabase},
  );
  gh.lazySingleton<_i20.FastUserService>(
    () => _i21.AppwriteUserservice(),
    registerFor: {_appwrite},
  );
  gh.lazySingleton<_i20.FastUserService>(
    () => _i22.SupabaseUserService(),
    registerFor: {_supabase},
  );
  gh.lazySingleton<_i20.FastUserService>(
  ...
  gh.singleton<_i25.SubscriptionService>(_i25.SubscriptionService());
  gh.singleton<_i26.SettingsService>(_i26.SettingsService());
  return getIt;
}
