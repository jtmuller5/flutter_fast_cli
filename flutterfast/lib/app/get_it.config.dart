...
import '../features/feedback/services/firebase_feedback_service.dart' as _i25;
import '../features/feedback/services/pocketbase_feedback_service.dart' as _i26;
...
import '../modules/chat/services/appwrite_chat_service.dart' as _i16;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.lazySingleton<_i24.FastFeedbackService>(
    () => _i25.FirebaseFeedbackService(),
    registerFor: {_firebase},
  );
  gh.lazySingleton<_i24.FastFeedbackService>(
    () => _i26.PocketBaseFeedbackService(),
    registerFor: {_pocketbase},
  );
  gh.lazySingleton<_i24.FastFeedbackService>(
  ...
  gh.factory<_i34.NavigationService>(() => _i34.NavigationService());
  await gh.factoryAsync<_i35.SharedPreferences>(
    () => registerModule.sharedPrefs,
    preResolve: true,
  );
  gh.singleton<_i36.SubscriptionService>(_i36.SubscriptionService());
