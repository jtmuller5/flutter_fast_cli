...
Future<void> clearUnusedAnalyticsFiles(String analytics) async {
  ...
  File firebaseAnalyticsServiceFile = File('${analyticsDirectory.path}/firebase_analytics_service.dart');
  ...
  if (analytics == 'amplitude') {
    ...
    await firebaseAnalyticsServiceFile.delete();
    removeFeatureFromFile('Fanalytics', 'lib/main.dart');
    removeFeatureFromFile('Fanalytics', 'web/index.html');
    removeFeatureFromFile('Fanalytics', 'lib/app/get_it.dart');
